...
import HeroImage from "../videos/mountains.png";
import HeroPoster from "../videos/mountain-small.png";
import HeroImages from "../videos/mountain.png";
        ...
        <section className={'hero-section'}>
            <div className={'video-container'}>
                <div className={'video-wrapper'}>
                    ...
                    <video id={'hero-video'} autoPlay={true} preload={'none'} loop={true} playsInline={true} muted={true} poster={HeroPoster}>
                        {isSafari &&
                            <source src={HeroImage} type='video/mp4;codecs="hvc1"'/>
                        }
                        {!isSafari &&
                            <source src={HeroImages} type="video/webm" />
                        }
                    </video>
                </div>
            </div>
